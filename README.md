...
- 🔐 **Cybersecurity** — vulnerabilities, pen testing, secure systems design
- ⚡ **Performance Testing** — load testing, profiling, benchmarking
- 🌐 **Web Development** — building modern, fast frontends with React, Vite & TanStack
- 🛠️ **System-level thinking** — how things work under the hood
